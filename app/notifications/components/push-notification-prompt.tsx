...
import { requestNotificationPermission, isNotificationEnabled } from '@/utils/firebase/messaging';
...
export function PushNotificationPrompt() {
  ...
  const handleEnableNotifications = async () => {
    ...
    try {
      ...
      if (token) {
        ...
        const { registerFCMToken } = useNotificationStore.getState();
  ...
  const handleDisableNotifications = async () => {
    ...
    setIsLoading(true);
    try {
      const { unregisterFCMToken } = useNotificationStore.getState();
